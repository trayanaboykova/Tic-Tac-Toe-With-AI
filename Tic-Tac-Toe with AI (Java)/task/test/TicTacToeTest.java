...
public class TicTacToeTest extends StageTest<String> {
    ...
    CheckResult testGridOutput(Test testCase) {
        ...
        if (testCase.additionalContains != null && !output.toLowerCase().contains(testCase.additionalContains.toLowerCase())) {
        ...
        if (!output.toLowerCase().contains(testCase.state.toLowerCase())) {
